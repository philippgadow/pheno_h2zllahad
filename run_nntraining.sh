...
REG_OPTUNA_TRIALS=${REG_OPTUNA_TRIALS:-40}
CLS_OPTUNA_TRIALS=${CLS_OPTUNA_TRIALS:-40}
REG_OPTUNA_DB="${REG_OUTPUT}/optuna_regression.db"
CLS_OPTUNA_DB="${CLS_OUTPUT}/optuna_classification.db"
