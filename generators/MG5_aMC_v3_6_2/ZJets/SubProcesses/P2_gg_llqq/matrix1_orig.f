...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1_1(W(1,5),W(1,7),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(1,10),W(1,5),W(1,7),-GC_50,GC_58,AMP(4))
      CALL FFV1_1(W(1,5),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
      CALL FFV1_2(W(1,6),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,9),W(1,10),W(1,8),GC_2,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_5_0(W(1,9),W(1,10),W(1,7),-GC_50,GC_58,AMP(6))
      CALL FFV1_1(W(1,10),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_1(W(1,5),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,4),W(1,10),W(1,8),GC_2,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV2_5_0(W(1,4),W(1,10),W(1,7),-GC_50,GC_58,AMP(10))
      CALL FFV1_2(W(1,4),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,3),W(1,5),W(1,8),GC_2,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_5_0(W(1,3),W(1,5),W(1,7),-GC_50,GC_58,AMP(12))
...
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,3),W(1,5),W(1,8),GC_2,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_5_0(W(1,3),W(1,5),W(1,7),-GC_50,GC_58,AMP(16))
