...
C      where in initialization mode as well for the helicity.
     ...
     $  THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,5) .OR. NTRY(5).LE.MAXTRIES.OR.(ISUM_HEL.NE.0))
     $      THEN
            T=MATRIX5(P ,NHEL(1,I),JC(1),I,AMP2, JAMP2, IVEC)
     ...
     $       .EQ.0.AND.ALLOW_HELICITY_GRID_ENTRIES) THEN
          ...
          ENDIF
        ENDDO
        IF(NTRY(5).EQ.(MAXTRIES+1).AND.DS_GET_DIM_STATUS('Helicity')
     $   .NE.-1) THEN
...
C            update.
     ...
     $              'IMIRROR', IMIRROR
                ENDIF
              ELSE IF (.NOT.GOODHEL(I,5) .AND. (DABS(TS(I)).GT.ANS
     $         *LIMHEL/NCOMB)) THEN
                GOODHEL(I,5)=.TRUE.
                NGOOD = NGOOD +1
                PRINT *,'Added good helicity ',I, 'for process 5',TS(I)
     $           *NCOMB/ANS,' in event ',NTRY(5)
              ENDIF
            ENDDO
          ENDIF
          IF(NTRY(5).EQ.MAXTRIES)THEN
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX5(P,NHEL,IC, IHEL,AMP2, JAMP2, IVEC)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.6.2, 2025-03-19
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1_2(W(1,6),W(1,7),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_2,AMP(1))
      CALL FFV1_1(W(1,2),W(1,7),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,6),W(1,10),W(1,8),GC_2,AMP(2))
      CALL FFV2_4_3(W(1,3),W(1,4),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,9),W(1,2),W(1,7),-GC_50,GC_58,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(1,6),W(1,10),W(1,7),-GC_50,GC_58,AMP(4))
      CALL FFV1P0_3(W(1,5),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
      CALL FFV1_2(W(1,6),W(1,10),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,9),W(1,1),W(1,8),GC_2,AMP(5))
      CALL FFV1_1(W(1,1),W(1,10),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,6),W(1,4),W(1,8),GC_2,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_5_0(W(1,9),W(1,1),W(1,7),-GC_50,GC_58,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_5_0(W(1,6),W(1,4),W(1,7),-GC_50,GC_58,AMP(8))
      CALL FFV1P0_3(W(1,6),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
      CALL FFV1_2(W(1,5),W(1,4),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_2,AMP(9))
      CALL FFV1_2(W(1,5),W(1,8),GC_2,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,10),W(1,2),W(1,4),GC_11(IVEC),AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,9),W(1,2),W(1,7),-GC_50,GC_58,AMP(11))
      CALL FFV2_5_2(W(1,5),W(1,7),-GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,9),W(1,2),W(1,4),GC_11(IVEC),AMP(12))
      CALL FFV1P0_3(W(1,6),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
      CALL FFV1_2(W(1,5),W(1,4),GC_11(IVEC),ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,6),W(1,1),W(1,8),GC_2,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,10),W(1,1),W(1,4),GC_11(IVEC),AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_5_0(W(1,6),W(1,1),W(1,7),-GC_50,GC_58,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,9),W(1,1),W(1,4),GC_11(IVEC),AMP(16))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      JAMP(1,1) = (5.000000000000000D-01)*TMP_JAMP(13)
     $ +(1.666666666666667D-01)*TMP_JAMP(14)
      JAMP(2,1) = (-1.666666666666667D-01)*TMP_JAMP(13)+(
     $ -5.000000000000000D-01)*TMP_JAMP(14)
