...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1P0_3(W(1,6),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1_2(W(1,6),W(1,10),GC_11(IVEC),ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,5),W(1,8),GC_2,AMP(5))
      CALL FFV1_2(W(1,6),W(1,8),GC_2,ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,1),W(1,5),W(1,10),GC_11(IVEC),AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_5_0(W(1,2),W(1,5),W(1,7),-GC_50,GC_58,AMP(7))
      CALL FFV2_5_2(W(1,6),W(1,7),-GC_50,GC_58,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,2),W(1,5),W(1,10),GC_11(IVEC),AMP(8))
