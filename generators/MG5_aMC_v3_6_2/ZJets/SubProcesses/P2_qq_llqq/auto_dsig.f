...
C     and update the couplings accordingly
      ...
      IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! u c > e+ e- u c
      IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! u d > e+ e- u d
      IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! u u~ > e+ e- c c~
      IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! u u~ > e+ e- d d~
      IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! u c~ > e+ e- u c~
      IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! u d~ > e+ e- u d~
      IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! d s > e+ e- d s
      IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! d u~ > e+ e- d u~
      IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! d d~ > e+ e- u u~
      IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! d d~ > e+ e- s s~
      IF(IPROC.EQ.17) DSIGPROC=DSIG17(P1,WGT,IMODE)  ! d s~ > e+ e- d s~
      IF(IPROC.EQ.18) DSIGPROC=DSIG18(P1,WGT,IMODE)  ! u~ c~ > e+ e- u~ c~
      IF(IPROC.EQ.19) DSIGPROC=DSIG19(P1,WGT,IMODE)  ! u~ d~ > e+ e- u~ d~
      IF(IPROC.EQ.20) DSIGPROC=DSIG20(P1,WGT,IMODE)  ! d~ s~ > e+ e- d~ s~
C     ENDIF
