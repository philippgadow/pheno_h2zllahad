...
C     
C     Process: d d~ > e+ e- g WEIGHTED<=5 @1
C     Process: d d~ > mu+ mu- g WEIGHTED<=5 @1
C     Process: s s~ > e+ e- g WEIGHTED<=5 @1
C     Process: s s~ > mu+ mu- g WEIGHTED<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,3),I=0,5) /7, 1,-1,-1, 1,-1/
      DATA (NHEL(I,4),I=0,5) /8, 1,-1,-1, 1, 1/
      DATA (NHEL(I,5),I=0,5) /25,-1, 1, 1,-1,-1/
      DATA (NHEL(I,6),I=0,5) /26,-1, 1, 1,-1, 1/
      DATA (NHEL(I,7),I=0,5) /31,-1, 1,-1, 1,-1/
      DATA (NHEL(I,8),I=0,5) /32,-1, 1,-1, 1, 1/
      DATA IDEN/36/
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,1),ZERO,-1,+1*IC(1),W(1,2))  !  count 10
      ...
      CALL VXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,9))  !  count 4
      CALL VXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,10))  !  count 4
      CALL FFV1_2(W(1,1),W(1,9),GC_11(IVEC),ZERO,FK_ZERO,W(1,11))  !  count 4
      CALL FFV1_2(W(1,1),W(1,10),GC_11(IVEC),ZERO,FK_ZERO,W(1,12))  !  count 4
      CALL FFV1_2(W(1,2),W(1,9),GC_11(IVEC),ZERO,FK_ZERO,W(1,13))  !  count 4
      CALL FFV1_2(W(1,2),W(1,10),GC_11(IVEC),ZERO,FK_ZERO,W(1,14))  !  count 4
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,3),W(1,9),GC_11(IVEC),ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV1_1(W(1,3),W(1,10),GC_11(IVEC),ZERO,FK_ZERO,W(1,20))  !  count 4
      CALL FFV1_1(W(1,4),W(1,9),GC_11(IVEC),ZERO,FK_ZERO,W(1,21))  !  count 4
      CALL FFV1_1(W(1,4),W(1,10),GC_11(IVEC),ZERO,FK_ZERO,W(1,22))  !  count 4
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3P1N_2(W(1,1), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/21,22/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_2(W(1,1), W(1,18), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/21,22/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_2(W(1,2), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,5/), 
     & (/19,20/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_2(W(1,2), W(1,18), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/8,7/), 
     & (/19,20/),
