...
C     
C     Process: u u~ > e+ e- g WEIGHTED<=5 @1
C     Process: u u~ > mu+ mu- g WEIGHTED<=5 @1
C     Process: c c~ > e+ e- g WEIGHTED<=5 @1
C     Process: c c~ > mu+ mu- g WEIGHTED<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFV1P1N_2(W(1,1), W(1,15), GC_2, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/21,22/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_2(W(1,1), W(1,16), GC_2, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/21,22/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_2(W(1,2), W(1,15), GC_2, TMP(1))
      call CombineAmp(2,
     & (/6,5/), 
     & (/19,20/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_2(W(1,2), W(1,16), GC_2, TMP(1))
      call CombineAmp(2,
     & (/8,7/), 
     & (/19,20/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5P1N_2(W(1,1), W(1,17), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/21,22/),
     & TMP, W, AMP(1,4))
      CALL FFV2_5P1N_2(W(1,1), W(1,18), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/21,22/),
     & TMP, W, AMP(1,4))
      CALL FFV2_5P1N_2(W(1,2), W(1,17), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,5/), 
     & (/19,20/),
     & TMP, W, AMP(1,4))
      CALL FFV2_5P1N_2(W(1,2), W(1,18), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/8,7/), 
     & (/19,20/),
