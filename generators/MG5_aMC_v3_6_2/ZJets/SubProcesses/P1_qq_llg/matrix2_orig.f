...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1_2(W(1,1),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,6))
      CALL FFV1P0_3(W(1,3),W(1,4),GC_3,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,2),W(1,7),GC_1,AMP(1))
      CALL FFV2_4_3(W(1,3),W(1,4),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(1,6),W(1,2),W(1,8),GC_50,GC_58,AMP(2))
      CALL FFV1_1(W(1,2),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,1),W(1,6),W(1,7),GC_1,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,1),W(1,6),W(1,8),GC_50,GC_58,AMP(4))
