...
C     ----------
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV2_3P1N_1(W(1,9), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/5,1/), 
     & (/11,12/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,9), W(1,18), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,2/), 
     & (/11,12/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,10), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/7,3/), 
     & (/13,14/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,10), W(1,18), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/8,4/), 
     & (/13,14/),
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3P1N_2(W(1,3), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/5,1/), 
     & (/19,20/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_2(W(1,3), W(1,18), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,2/), 
     & (/19,20/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_2(W(1,4), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/7,3/), 
     & (/21,22/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_2(W(1,4), W(1,18), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/8,4/), 
     & (/21,22/),
