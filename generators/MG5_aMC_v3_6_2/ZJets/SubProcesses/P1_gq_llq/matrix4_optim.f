...
C     
C     Process: g d~ > e+ e- d~ WEIGHTED<=5 @1
C     Process: g d~ > mu+ mu- d~ WEIGHTED<=5 @1
C     Process: g s~ > e+ e- s~ WEIGHTED<=5 @1
C     Process: g s~ > mu+ mu- s~ WEIGHTED<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,2),I=0,5) /8,-1,-1,-1, 1,-1/
      DATA (NHEL(I,3),I=0,5) /9,-1, 1, 1,-1, 1/
      DATA (NHEL(I,4),I=0,5) /15,-1, 1,-1, 1, 1/
      DATA (NHEL(I,5),I=0,5) /18, 1,-1, 1,-1,-1/
      DATA (NHEL(I,6),I=0,5) /24, 1,-1,-1, 1,-1/
      DATA (NHEL(I,7),I=0,5) /25, 1, 1, 1,-1, 1/
      DATA (NHEL(I,8),I=0,5) /31, 1, 1,-1, 1, 1/
      DATA IDEN/96/
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL OXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4))  !  count 10
      ...
      CALL IXXXXX(P(0,5),ZERO,+1,-1*IC(5),W(1,9))  !  count 10
      CALL IXXXXX(P(0,5),ZERO,-1,-1*IC(5),W(1,10))  !  count 10
      CALL FFV1_2(W(1,9),W(1,1),GC_11(IVEC),ZERO,FK_ZERO,W(1,11))  !  count 4
      CALL FFV1_2(W(1,9),W(1,2),GC_11(IVEC),ZERO,FK_ZERO,W(1,12))  !  count 4
      CALL FFV1_2(W(1,10),W(1,1),GC_11(IVEC),ZERO,FK_ZERO,W(1,13))  !  count 4
      CALL FFV1_2(W(1,10),W(1,2),GC_11(IVEC),ZERO,FK_ZERO,W(1,14))  !  count 4
      CALL FFV1P0_3(W(1,5),W(1,8),GC_3,ZERO,FK_ZERO,W(1,15))  !  count 8
      CALL FFV1P0_3(W(1,6),W(1,7),GC_3,ZERO,FK_ZERO,W(1,16))  !  count 8
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_4_3(W(1,5),W(1,8),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,17))  !  count 8
      CALL FFV2_4_3(W(1,6),W(1,7),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,18))  !  count 8
      CALL FFV2_3P1N_1(W(1,3), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/7,3/), 
     & (/11,12/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,3), W(1,18), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/8,4/), 
     & (/11,12/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,4), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/5,1/), 
     & (/13,14/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,4), W(1,18), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,2/), 
     & (/13,14/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,3),W(1,1),GC_11(IVEC),ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV1_1(W(1,3),W(1,2),GC_11(IVEC),ZERO,FK_ZERO,W(1,20))  !  count 4
      CALL FFV1_1(W(1,4),W(1,1),GC_11(IVEC),ZERO,FK_ZERO,W(1,21))  !  count 4
      CALL FFV1_1(W(1,4),W(1,2),GC_11(IVEC),ZERO,FK_ZERO,W(1,22))  !  count 4
      CALL FFV1P1N_2(W(1,9), W(1,15), GC_1, TMP(1))
      call CombineAmp(2,
     & (/7,3/), 
     & (/19,20/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_2(W(1,9), W(1,16), GC_1, TMP(1))
      call CombineAmp(2,
     & (/8,4/), 
     & (/19,20/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_2(W(1,10), W(1,15), GC_1, TMP(1))
      call CombineAmp(2,
     & (/5,1/), 
     & (/21,22/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_2(W(1,10), W(1,16), GC_1, TMP(1))
      call CombineAmp(2,
     & (/6,2/), 
     & (/21,22/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3P1N_2(W(1,9), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/7,3/), 
     & (/19,20/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_2(W(1,9), W(1,18), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/8,4/), 
     & (/19,20/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_2(W(1,10), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/5,1/), 
     & (/21,22/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_2(W(1,10), W(1,18), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,2/), 
     & (/21,22/),
