...
C     ----------
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV2_5P1N_1(W(1,3), W(1,17), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/7,3/), 
     & (/11,12/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,3), W(1,18), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/8,4/), 
     & (/11,12/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,4), W(1,17), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/5,1/), 
     & (/13,14/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,4), W(1,18), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,2/), 
     & (/13,14/),
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFV1P1N_2(W(1,9), W(1,15), GC_2, TMP(1))
      call CombineAmp(2,
     & (/7,3/), 
     & (/19,20/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_2(W(1,9), W(1,16), GC_2, TMP(1))
      call CombineAmp(2,
     & (/8,4/), 
     & (/19,20/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_2(W(1,10), W(1,15), GC_2, TMP(1))
      call CombineAmp(2,
     & (/5,1/), 
     & (/21,22/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_2(W(1,10), W(1,16), GC_2, TMP(1))
      call CombineAmp(2,
     & (/6,2/), 
     & (/21,22/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5P1N_2(W(1,9), W(1,17), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/7,3/), 
     & (/19,20/),
     & TMP, W, AMP(1,4))
      CALL FFV2_5P1N_2(W(1,9), W(1,18), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/8,4/), 
     & (/19,20/),
     & TMP, W, AMP(1,4))
      CALL FFV2_5P1N_2(W(1,10), W(1,17), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/5,1/), 
     & (/21,22/),
     & TMP, W, AMP(1,4))
      CALL FFV2_5P1N_2(W(1,10), W(1,18), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,2/), 
     & (/21,22/),
