...
C     
C     Process: g u > e+ e- u WEIGHTED<=5 @1
C     Process: g u > mu+ mu- u WEIGHTED<=5 @1
C     Process: g c > e+ e- c WEIGHTED<=5 @1
C     Process: g c > mu+ mu- c WEIGHTED<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,2),ZERO,+1,+1*IC(2),W(1,3))  !  count 10
      CALL IXXXXX(P(0,2),ZERO,-1,+1*IC(2),W(1,4))  !  count 10
      ...
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,10))  !  count 10
      CALL FFV1_2(W(1,3),W(1,1),GC_11(IVEC),ZERO,FK_ZERO,W(1,11))  !  count 4
      CALL FFV1_2(W(1,3),W(1,2),GC_11(IVEC),ZERO,FK_ZERO,W(1,12))  !  count 4
      CALL FFV1_2(W(1,4),W(1,1),GC_11(IVEC),ZERO,FK_ZERO,W(1,13))  !  count 4
      CALL FFV1_2(W(1,4),W(1,2),GC_11(IVEC),ZERO,FK_ZERO,W(1,14))  !  count 4
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV2_5P1N_1(W(1,9), W(1,17), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/5,1/), 
     & (/11,12/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,9), W(1,18), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,2/), 
     & (/11,12/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,10), W(1,17), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/7,3/), 
     & (/13,14/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,10), W(1,18), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/8,4/), 
     & (/13,14/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,9),W(1,1),GC_11(IVEC),ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV1_1(W(1,9),W(1,2),GC_11(IVEC),ZERO,FK_ZERO,W(1,20))  !  count 4
      CALL FFV1_1(W(1,10),W(1,1),GC_11(IVEC),ZERO,FK_ZERO,W(1,21))  !  count 4
      CALL FFV1_1(W(1,10),W(1,2),GC_11(IVEC),ZERO,FK_ZERO,W(1,22))  !  count 4
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5P1N_2(W(1,3), W(1,17), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/5,1/), 
     & (/19,20/),
     & TMP, W, AMP(1,4))
      CALL FFV2_5P1N_2(W(1,3), W(1,18), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,2/), 
     & (/19,20/),
     & TMP, W, AMP(1,4))
      CALL FFV2_5P1N_2(W(1,4), W(1,17), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/7,3/), 
     & (/21,22/),
     & TMP, W, AMP(1,4))
      CALL FFV2_5P1N_2(W(1,4), W(1,18), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/8,4/), 
     & (/21,22/),
