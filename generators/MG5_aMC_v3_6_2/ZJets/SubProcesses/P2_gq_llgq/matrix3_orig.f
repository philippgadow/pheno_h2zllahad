...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL VVV1P0_1(W(1,1),W(1,5),GC_10(IVEC),ZERO, FK_ZERO,W(1,7))
      CALL FFV1P0_3(W(1,3),W(1,4),GC_3,ZERO, FK_ZERO,W(1,8))
      CALL FFV1_1(W(1,2),W(1,7),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,9),W(1,8),GC_2,AMP(1))
      CALL FFV1_2(W(1,6),W(1,7),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,10),W(1,2),W(1,8),GC_2,AMP(2))
      CALL FFV2_4_3(W(1,3),W(1,4),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,6),W(1,9),W(1,7),-GC_50,GC_58,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(1,10),W(1,2),W(1,7),-GC_50,GC_58,AMP(4))
      CALL FFV1_1(W(1,2),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
      CALL FFV1_2(W(1,6),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,9),W(1,10),W(1,8),GC_2,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_5_0(W(1,9),W(1,10),W(1,7),-GC_50,GC_58,AMP(6))
      CALL FFV1_1(W(1,10),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,6),W(1,4),W(1,8),GC_2,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_5_0(W(1,6),W(1,4),W(1,7),-GC_50,GC_58,AMP(8))
      CALL FFV1_2(W(1,6),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
      CALL FFV1_1(W(1,2),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,4),W(1,10),W(1,8),GC_2,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV2_5_0(W(1,4),W(1,10),W(1,7),-GC_50,GC_58,AMP(10))
      CALL FFV1_2(W(1,4),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_2,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_5_0(W(1,3),W(1,2),W(1,7),-GC_50,GC_58,AMP(12))
      CALL FFV1_1(W(1,10),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,6),W(1,3),W(1,8),GC_2,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,6),W(1,3),W(1,7),-GC_50,GC_58,AMP(14))
      CALL FFV1_2(W(1,9),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_2,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_5_0(W(1,3),W(1,2),W(1,7),-GC_50,GC_58,AMP(16))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      JAMP(1,1) = (-1.000000000000000D+00)*AMP(5)+(-1.000000000000000D
     $ +00)*AMP(6)+(-1.000000000000000D+00)*AMP(7)+(
     $ -1.000000000000000D+00)*AMP(8)+(-1.000000000000000D+00)*AMP(15)
     $ +(-1.000000000000000D+00)*AMP(16)+((0.000000000000000D+00
     $ ,1.000000000000000D+00))*TMP_JAMP(3)
     ...
     $ +(-1.000000000000000D+00)*AMP(14)+((0.000000000000000D+00,
     $ -1.000000000000000D+00))*TMP_JAMP(3)
